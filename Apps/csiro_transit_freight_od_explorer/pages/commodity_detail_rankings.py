...
# Back links
col_back1, col_back2, col_back3, _ = st.columns([1, 1, 1, 4])
with col_back1:
    st.page_link("app.py", label="\u2190 OD Metrics", icon="\U0001f69b")
with col_back2:
    st.page_link("pages/od_rankings.py", label="\u2190 All Types", icon="\U0001f4ca")
with col_back3:
    st.page_link("pages/commodity_rankings.py", label="\u2190 Commodity Groups", icon="\U0001f3f7\ufe0f")
...
# Bottom back links
col_back1b, col_back2b, col_back3b, _ = st.columns([1, 1, 1, 4])
with col_back1b:
    st.page_link("app.py", label="\u2190 OD Metrics", icon="\U0001f69b")
with col_back2b:
    st.page_link("pages/od_rankings.py", label="\u2190 All Types", icon="\U0001f4ca")
